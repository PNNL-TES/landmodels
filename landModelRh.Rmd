...
```{r temporal casa, fig.width=10, fig.height=8}
# CASA-CRUNCEP
...
mgrhd_sub %>% 
  ...
  ggplot(aes(x = Meas_DOY, y = Rh_Norm)) +
  geom_line(col = "gray") + 
  geom_line(aes(x = Meas_DOY, y = gswp3_corpse), col = "#00C1AA", alpha = 0.75) +
  facet_wrap(.~Climate_full_name, ncol = 1) +
  theme(axis.text.y = element_blank(),
  axis.ticks.y = element_blank()) +
  labs(title = "CORPSE-GSWP3", x = "Day of year",
       y = element_blank()) -> temp_corpsegswp3
...
mgrhd_sub %>% 
  ...
  ggplot(aes(x = Meas_DOY, y = Rh_Norm)) +
  geom_line(col = "gray") + 
  geom_line(aes(x = Meas_DOY, y = gswp3_mimics), col = "blue", alpha = 0.75) +
  facet_wrap(.~Climate_full_name, ncol = 1) +
  theme(axis.text.y = element_blank(),
  axis.ticks.y = element_blank()) +
  labs(title = "MIMICS-GSWP3", x = "Day of year",
       y = element_blank()) -> temp_mimicsgswp3

temp_casacru | temp_casagswp3 | temp_corpsegswp3 | temp_mimicsgswp3
```
